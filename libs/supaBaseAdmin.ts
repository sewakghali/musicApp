...
export const manageSubscriptionsChange = async(customerId: string, subscriptionId: string, createAction=false)=>{
   ...
   const {error: subscriptionUpsertErr} = await supabaseAdmin.from('subscriptions').upsert([subscriptionData]);
